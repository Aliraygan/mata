...
local settings = data[tostring(target)]["settings"] 
 text ="*⚙gяσυρ ѕєттιηgѕ:*\n》*Ն૦८қ є∂ιт :* "..settings.lock_edit.."\n》*Ն૦८қ ℓιηкѕ :* "..settings.lock_link.."\n》*Ն૦८қ username :* "..settings.lock_username.."\n》*Ն૦८қ hashtag :* "..settings.lock_hashtags.."\n》*Ն૦८қ ƒℓσσ∂ :* "..settings.flood.."\n》*Ն૦८қ ѕραм :* "..settings.lock_spam.."\n》*Ն૦८қ мєηтιση :* "..settings.lock_mention.."\n》*Ն૦८қ αяαвιc :* "..settings.lock_arabic.."\n》*Ն૦८қ ωєвραgє :* "..settings.lock_webpage.."\n》*Ն૦८қ мαяк∂σωη :* "..settings.lock_markdown.."\n》*Ն૦८қ єηgℓιѕн :* "..settings.english.."\n》*Ն૦८қ ƒσѕн :* "..settings.fosh.."\n》*Ն૦८қ α∂ѕ :* "..settings.ads.."\n》*Ն૦८қ νιєωѕ :* "..settings.views.."\n》*Ն૦८қ ємσנι :* "..settings.emoji.."\n》*gяσυρ ωєℓcσмє :* "..settings.welcome.."\n》*Ն૦८қ ριη мєѕѕαgє :* "..settings.lock_pin.."\n》*Ն૦८қ tabchi :* "..settings.lock_tabchi.."\n》*вσтѕ ρяσтєcтιση :* "..settings.lock_bots.."\n*》ƒℓσσ∂ ѕєηѕιтινιту:* *"..NUM_MSG_MAX.."*\n*____________________*\n*⚙gяσυρ мυтє ℓιѕт* :\n》*ᗰυ੮૯ αℓℓ : * "..settings.mute_all.."\n》*ᗰυ੮૯ gιƒ :* "..settings.mute_gif.."\n》*ᗰυ੮૯ тєχт :* "..settings.mute_text.."\n》*ᗰυ੮૯ ιηℓιηє :* "..settings.mute_inline.."\n》*ᗰυ੮૯ gαмє :* "..settings.mute_game.."\n》*мυтє ρнσтσ :* "..settings.mute_photo.."\n》*ᗰυ੮૯ νι∂єσ :* "..settings.mute_video.."\n》*ᗰυ੮૯ αυ∂ισ :* "..settings.mute_audio.."\n》*ᗰυ੮૯ νσιcє :* "..settings.mute_voice.."\n》*ᗰυ੮૯ ѕтιcкєя :* "..settings.mute_sticker.."\n》*ᗰυ੮૯ cσηтαcт :* "..settings.mute_contact.."\n》*ᗰυ੮૯ ƒσяωαя∂ :* "..settings.mute_forward.."\n》*ᗰυ੮૯ ℓσcαтιση :* "..settings.mute_location.."\n》*ᗰυ੮૯ ∂σcυмєηт :* "..settings.mute_document.."\n》*ᗰυ੮૯ тgѕєяνιcє :* "..settings.mute_tgservice.."\n》*ᗰυ੮૯ кєувσαя∂ :* "..settings.mute_keyboard.."\n*____________________*\n*🌐gяσυρ ℓαηgυαgє* : єη\n🗓*єχριя:* _"..expire_date.."_\n*✒ѕυ∂σ вσт:* @MahDiRoO"
else
